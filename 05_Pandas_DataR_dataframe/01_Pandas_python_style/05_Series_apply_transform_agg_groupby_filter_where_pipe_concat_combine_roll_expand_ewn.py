...
8. .concat(): Concatenation of Series
9. .combine(): Element-wise Merging
10. .pipe(): Method Chaining with Custom Functions
11. .rolling(): Rolling Window Calculations (short-term trends)
12. .expanding(): Expanding Window Calculations (long-term trends)
13. .ewm(): Exponential Weighted Functions
'''
