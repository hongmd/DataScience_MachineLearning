...
5. From a dictionary of tuples: {("col1", "col2"): {("row1", "row2"): val, ...}, ...}
6. From a list of namedtuples: [namedtuple1, namedtuple2, ...]
7. From a list of dataclasses: [dataclass1, dataclass2, ...]
8. Other constructors: .from_dict(), .from_records()
'''
